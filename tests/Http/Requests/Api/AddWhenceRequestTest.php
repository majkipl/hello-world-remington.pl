...
class AddWhenceRequestTest extends ValidationTestCase
{
    ...
    public function validation_pass_for_valid_data()
    {
        ...
        $validator = Validator::make($data, (new AddWhenceRequest())->rules());
    ...
    public function validation_fails_if_name_is_missing()
    {
        ...
        $this->expectValidationException($data, AddWhenceRequest::class);
    }
