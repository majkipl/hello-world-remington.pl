...
class IndexWhenceRequestTest extends ValidationTestCase
{
    ...
    public function validation_pass_for_valid_data()
    {
        ...
        $this->runValidationTest($data, IndexWhenceRequest::class);
    }
    ...
    public function validation_fails_if_searchable_is_not_exists()
    {
        ...
        $this->expectValidationException($data, IndexWhenceRequest::class);
    }
